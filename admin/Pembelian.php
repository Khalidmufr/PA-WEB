        ...
        <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <div class="Isi">
                  <h1>Form Input</h1>
                  <form>
            <span class="sub">no pembelian</span>
            <input type="text" id="a" placeholder="Masukkan Nomor" name="a">
            <span class="sub">no produk</span>
            <input type="text" id="a" placeholder="Masukkan Nomor" name="a">
            <span class="sub">no role</span>
            <input type="text" id="a" placeholder="Masukkan Nomor" name="a">
            <span class="sub">alamat</span>
            <input type="text" id="b" placeholder="Masukkan Alamat" name="b">
            <span class="sub">Jumlah</span>
            <input type="text" id="c" placeholder="Masukkan Jumlah" name="c">
            <span class="sub">uang</span>  
            <input type="text" id="d" placeholder="Masukkan Uang" name="d">
            <br>
