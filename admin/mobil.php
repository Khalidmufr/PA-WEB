        ...
        <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <div class="Isi">
                  <h1>Form Input</h1>
                  <form>                   
                    <span class="sub">merk</span>
                    <input type="text" id="ba" placeholder="Masukkan merk" name="b">
                    <span class="sub">warna</span>
                    <input type="text" id="ca" placeholder="Masukkan warna" name="c">
                    <span class="sub">Plat</span>  
                    <input type="text" id="da" placeholder="Masukkan Plat" name="d">
                    <br>            
                  ...
                  <h1 class="text-center">Tabel Mobil</h1>
                    ...
                    <table id="tabel" class="table table-hover" border="2" cellspacing="0" width="100%">
                      ...
                      <tr>
                        <th rowspan="1" bgcolor="yellowgreen">id_mobil</th>
                        <th rowspan="1" bgcolor="yellowgreen">merk</th>
                        <th rowspan="1" bgcolor="yellow">warna</th>
